...
from ..models import Settings, Items
from ..schemas import SettingsSchema, ItemsInSchema, ItemsSchema
...
async def remove(item_id: int, dependency = Depends(verify_localhost)):
    ...
    if not deleted_count:
        return Response(f'Participant with id={item_id} not found', status_code=status.HTTP_404_NOT_FOUND)
